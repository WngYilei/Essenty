...
setupDefaults(
    ...
    publicationConfig = PublicationConfig(
        ...
        repositoryUrl = findProperty("MAVEN_REPOSITORY_URL") as String,
        repositoryUserName = findProperty("MAVEN_REPOSITORY_USERNAME") as String,
        repositoryPassword = findProperty("MAVEN_REPOSITORY_PASSWORD") as String,
    ),
