    ...
    resolutionStrategy {
        eachPlugin {
            if (requested.id.toString() == "com.arkivanov.gradle.setup") {
                ...
                val localPlugin = file("${System.getProperty("user.home")}/.m2/repository/com/arkivanov/gradle/gradle-setup-plugin/0.0.1-KBA-001")
                if (localPlugin.exists()) {
                    useModule("com.arkivanov.gradle:gradle-setup-plugin:0.0.1-KBA-001")
                } else {
